...
// Dual Pricing start
	    $value_price_w = (float)$_POST['value_price_w'];
// Dual Pricing end
...
/* dual pricing start */
                            options_values_price_w = " . (float)$value_price_w . ",
/* dual pricing end */
...
<!--- Dual Pricing start --->
	    	<td class="dataTableHeadingContent text-center"><?php echo TABLE_HEADING_OPT_PRICE_W; ?></td>
<!--- Dual Pricing end --->
              ...
              if ($attributes_values->RecordCount() == 0) {
                ?>
                <tr>
                  <td colspan="11" class="pageHeading text-center">
...
<!--- Dual Pricing start --->
                        <div class="col-xs-6 col-sm-4 col-md-3 col-lg-2">
                           ...
                           <?php echo zen_draw_input_field('value_price_w', $attributes_value['options_values_price_w'], 'class="form-control" id="options_values_price_w"'); ?>
			</div>
<!--- Dual Pricing end --->
                        <div class="col-xs-6 col-sm-4 col-md-3 col-lg-2">
...
<!--- Dual Pricing start --->
	    	    <td class="text-right"><b><?php echo $attributes_value['options_values_price_w']; ?></b></td>
<!--- Dual Pricing end --->
...
<!--- Dual Pricing start --->
                    <td class="text-right"><?php echo $attributes_value['price_prefix']; ?>&nbsp;<?php echo $attributes_value['options_values_price_w']; ?></td>
<!--- Dual Pricing end --->
...
// BOF: Add dividers between Product Names and between Option Names
                ...
                /*
                  ...
                  <tr>
<!--- Dual Pricing start --->
                  <td colspan="11"><?php echo zen_draw_separator('pixel_black.gif', '100%', '3'); ?></td>
<!--- Dual Pricing end --->
		  </tr>
                  <?php
                  } else {
...
// set defaults for adding attributes
					  ...
					  <div class="col-xs-6 col-sm-4 col-md-3 col-lg-2">
                        <?php echo zen_draw_label(TABLE_HEADING_OPT_PRICE_W, 'options_values_price_w', 'class="control-label"'); ?>
                        <?php echo zen_draw_input_field('options_values_price_w', '', 'size="4" class="form-control" id="options_values_price_w"'); ?>
                      </div>
